...
import PveView from "../views/LandingPages/pve/Pve.vue";
import PvpView from "../views/LandingPages/pvp/Pvp.vue";
import PretenderView from "../views/LandingPages/Pretender/pretender.vue";
import AuthorView from "../views/LandingPages/Author/AuthorView.vue";
import SignInBasicView from "../views/LandingPages/SignIn/BasicView.vue";
import RegisterView from "../views/LandingPages/Register/Register.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/pages/landing-pages/pve",
      name: "pve",
      component: PveView,
    },
    {
      path: "/pages/landing-pages/pvp",
      name: "pvp",
      component: PvpView,
    },
    {
      path: "/pages/landing-pages/Pretender",
      name: "pretender",
      component: PretenderView,
    },
    {
