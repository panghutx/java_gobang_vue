    ...
    default: () => [
      {
        name: "",
        items: [
          // { name: "blog", href: "http://blog.youngsay.cn" },
          // { name: "在线oj", href: "http://blog.youngsay.cn" },
          // { name: "华理点评", href: "http://blog.youngsay.cn" }
        ]
      },
      {
        name: "",
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="text-dark my-4 text-sm font-weight-normal">
              ...
              <a href="https://www.github.com/panghutx" target="_blank"
                >五子棋作战</a
              >.
            </p>
          </div>
